...
автоматически делятся на несколько сообщений, а текст внутри каждого сообщения
собран в блоки по пять стихов.
...
4. В карточке видны книга, глава, прогресс цикла и диапазоны стихов; под последней
   частью доступны сохранение главы и настройки.
